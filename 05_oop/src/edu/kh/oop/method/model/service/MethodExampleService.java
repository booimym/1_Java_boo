...
public class MethodExampleService {
	...
	//3. 매개변수 x, 반환형 o인 메소드 만들기
	
	public String method3() {
		//void : 반환 값이 없다.
		//반환형 String : 해당 메서드 종료 시 String 자료형을 반환하겠다는 뜻.
		
		String str = ""; //빈 문자열(내용은 없는데 참조하는 객체는 존재함)
		
		str += "안녕하세요?\n";
		str += "오늘 점심 뭐드시나요?\n";
		str += "삼겹살이 먹고싶네요\n";
				
		//출력하는 곳이 아님(service임)  이걸 view에게 돌려줘서 출력하게 하고 싶다.(반환형)
		
		return str;
		
		//return : 현재 메서드를 종료하고 메서드 호출부로 돌아가겠다.

...
//	Example exam = new Example();
	...
	//1) Checked Exception		: 필수적으로 예외 처리 구문 작성해라
	//2) Unchecked Exception	: 선택적으로 예외 처리 구문 작성해라
	
	public void ex1() {
		
		//Scanner와 유사한 객체(속도는 더 빠름)
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		
		System.out.print("입력 :");
		//String input = br.readLine(); //== sc.nextLine();
		//readLine 누르고 shift+F2누르면
		//public String readLine() throws IOException 
		//readLine() 메서드는 IOException을 던질 가능성이 있기 떄문에 
		//호출 시 *반드시* 예외 처리를 하시오
		      //Checked Exception
	...
	public void ex2() {
		...
		try { 
			...
			//catch : try 구문 내에서 예외가 던져진 경우
			// 		매개 변수(참조형)을 이용해서 해당 객체를 잡음.
			//		(매개 변수에 예외 객체의 주소를 저장해서 참조한다.)
	...
	public void ex3() {
		...
		try {
		...
		} catch(InputMismatchException e) {//catch문 다중 작성이 가능합니다!!
			...
			// finally : catch구문 수행 여부에 관계 없이
			// 무조건 실행하는 구문
			
			System.out.println("프로그램 종료");
			
			
			//자원 반환 구문을 주로 finally에 작성함.
			sc.close();
		...
		// * 예외 발생
		// 	== throw new 예외 클래스()
		//	== 예외 객체가 생성되어서 던져진다는 뜻임.
		
		
		// * catch(부모 타입의 예외 참조 변수){ }
		// -> try에서 던져진 예외 객체가
